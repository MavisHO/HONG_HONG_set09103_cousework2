				...
				'<div id="videoSpeed">'+
					'<div class="videoBoxRe">'+
						...
						'<ul id="videoSpeedList">'+
							'<li class="videoSpeedStup" id="bs4">2.5Times</li>'+
							'<li class="videoSpeedStup" id="bs3">2.0Times</li>'+
							'<li class="videoSpeedStup" id="bs2">1.5Times</li>'+
							'<li class="videoSpeedStup" id="bs1">Default</li>'+
						'</ul>'+
					'</div>'+
				'</div>'+
				'<div id="videoSound">'+
...
function createVideo(dn,obj){
	...
	this.createDom  = function(){
		if( this.D("fz-videoBox") == null ){
			...
			console.log("Player node already exists.");
			return;
		}
	}
